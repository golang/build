...
# Permissions for triggering builders.
#
# may-start-trybots grants the permission to trigger public builds.
#
# The coordinator service accounts need to be able to trigger child
# builds in their respective realms as well.
luci.binding(
...
BUILDER_TYPES = [
    ...
    "linux-amd64_c2s16-perf_pgo_vs_oldest_stable-goamd64v3",
    "linux-amd64_c2s16-perf_vs_gopls_0_11",
    "linux-amd64_c2s16-perf_vs_parent",
    "linux-amd64_c2s16-perf_vs_parent-goamd64v3",
    "linux-amd64_c2s16-perf_vs_release",
    "linux-amd64_c2s16-perf_vs_release-goamd64v3",
    "linux-amd64_c2s16-perf_vs_tip",
    "linux-amd64_c2s16-perf_vs_tip-goamd64v3",
    "linux-amd64_c2s16-perf_vs_oldest_stable",
    "linux-amd64_c2s16-perf_vs_oldest_stable-goamd64v3",
...
KNOWN_ISSUE_BUILDER_TYPES = {
    "linux-amd64-racegocommand": known_issue(issue_number = 79779, hide_from_presubmit = False),
...
GO_BRANCHES = {
    ...
    SECOND_GO: struct(branch = "release-branch." + SECOND_GO, bootstrap = "1.24.6"),
}
...
golang/third_party/protoc_with_conformance/${platform} version:v35.1
""",
    ),
]
